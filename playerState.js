...
export class Rolling extends State {
    ...
    handleInput(input){
        ...
        if(input.includes('v') && this.game.player.onGround()){
            this.game.player.setState(states.RUNNING, 1);
        } else if(!input.includes('v') && !this.game.player.onGround()){
            this.game.player.setState(states.FALLING, 1);
        } else if(input.includes('v') && input.includes('ArrowUp') &&this.game.player.onGround()){
